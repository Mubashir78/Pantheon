// ── Pantheon Naming Map ──────────────────────────────────────────────
// These keys map from internal Hermes terminology to Pantheon display terms.
// The values below are the en (English) defaults. Other locale files
// translate the same keys. To swap display terms, change these values.
//
// Internal   →  UI Display
// session    →  Communion
// chat       →  Communion
...
// workspace  →  Forge
// memory     →  Athenaeum
// Hermes     →  Pantheon (app title only; the agent remains "Hermes")
// ─────────────────────────────────────────────────────────────────────
...
const LOCALES = {
  en: {
    ...
    session_imported: 'Communion imported',
    ...
    ws_search_placeholder: 'Search forges…',
    ws_no_results: 'No forges found',
    ...
    cmd_workspace: 'Switch forge by name',
    cmd_terminal: 'Open the forge terminal',
    cmd_new: 'Start a new communion',
    ...
    workspace_usage: 'Usage: /forge <name>',
    no_workspace_match: 'No forge matching "',
    switched_workspace: 'Switched to forge: ',
    workspace_switch_failed: 'Forge switch failed: ',
    new_session: 'New communion created',
    ...
    theme_set: 'Theme: ',
    no_active_session: 'No active communion',
  ...
  cmd_title:'Get or set the communion title',
  ...
  cmd_btw_usage:'/btw <question> — ask a side question using session context',
   ...
   cmd_branch:'Fork this conversation into a new communion',
   cmd_branch_usage:'/branch [name] — fork conversation (optionally with a name)',
   branch_forked:'Forked into new communion',
   branch_failed:'Fork failed: ',
   fork_from_here:'Fork from here',
   forked_from:'Forked from',
   subagent_children:'Subagent communions',
  ...
  cmd_status:'Show communion info',
  ...
  status_heading:'Communion Status',
  status_session_id:'Communion ID',
  status_title:'Title',
  status_model:'Model',
  ...
  cmd_webui_only_session:'This command is not available for CLI-imported communions.',
  ...
  usage_load_failed:'Failed to load usage: ',
    ...
    session_toolsets:'Communion Toolsets',
  ...
  untitled:'Untitled',
    ...
    failed_colon: 'Failed: ',
    // ui.js
    no_workspace: 'No forge',
    terminal_open_title: 'Open forge terminal',
    terminal_no_workspace_title: 'Select a forge to open terminal',
    ...
    workspace_empty_no_path: 'No forge selected. Set a forge in Settings → Workspace to browse files.',
    workspace_empty_dir: 'This forge is empty.',
  ...
  folder_add_as_space_msg: 'Add this folder as a new space in your forge list?',
  folder_add_as_space_title: 'Add as Space?',
    ...
    session_archived: 'Communion archived',
    session_restored: 'Communion restored',
    ...
    session_duplicated: 'Communion duplicated',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for Pantheon.',
    ...
    settings_label_workspace_panel_open: 'Keep forge panel open by default',
    settings_desc_workspace_panel_open: 'When enabled, the forge / file browser panel opens automatically with each new communion. You can still close it manually at any time.',
    ...
    settings_label_external_sessions: 'Show non-WebUI communions',
    ...
    tab_tasks: 'Tasks',
    tab_skills: 'Skills',
    tab_memory: 'Athenaeum',
    tab_workspaces: 'Forge',
    tab_profiles: 'Gods',
    tab_kanban: 'Kanban',
    kanban_board: 'Board',
    ...
    kanban_add_comment: 'Add comment',
      ...
      kanban_lanes_by_profile: 'Lanes by god',
    ...
    new_conversation: 'New communion',
    filter_conversations: 'Filter communions...',
    ...
    insights_model_sessions: 'Communions',
    ...
    workspace_desc: 'Add and switch forges for your communions.',
    ...
    settings_desc_sidebar_density: 'Controls how much metadata the communion list shows in the left sidebar.',
    ...
    settings_desc_external_sessions: 'Show conversations from CLI, Telegram, Discord, Slack, and other channels in the communion list. Click to import and continue.',
    ...
    suggest_files: 'What files are in this forge?',
    suggest_schedule: "What's on my schedule today?",
    suggest_plan: 'Help me plan a small project.',
    // onboarding
    onboarding_badge: 'FIRST RUN',
    onboarding_title: 'Welcome to Pantheon',
    onboarding_lead: 'A quick guided setup will verify the system, save a real provider configuration, choose a forge and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open Pantheon',
    ...
    onboarding_step_workspace_title: 'Forge + model',
    onboarding_step_workspace_desc: 'Pick defaults for new communions and chat.',
    ...
    onboarding_workspace_label: 'Forge',
    ...
    onboarding_workspace_help: 'Pick the model Hermes should use for new communions after setup completes.',
    ...
    workspaces_empty_title: 'Select a forge',
    workspaces_empty_sub: 'Pick a forge from the sidebar to view its files and settings, or add a new one.',
    profiles_empty_title: 'Select a god',
    profiles_empty_sub: 'Pick a god from the sidebar to view and edit its settings, or create a new one.',
    ...
    workspace_choose_path: 'Choose forge path',
    workspace_choose_path_meta: 'Add a validated path and switch this communion',
    workspace_manage: 'Manage forges',
    workspace_manage_meta: 'Open the Spaces panel',
    workspace_use_title: 'Use in current communion',
    workspace_use: 'Use',
    ...
    workspace_added: 'Forge added',
    workspace_renamed: 'Forge renamed',
    workspace_remove_confirm_title: 'Remove forge',
    workspace_remove_confirm_message: (path) => `Remove "${path}"?`,
    workspace_removed: 'Forge removed',
    workspace_switch_prompt_title: 'Switch forge',
    workspace_switch_prompt_message: 'Enter an absolute forge path to add and switch this communion to.',
    workspace_switch_prompt_confirm: 'Switch',
    workspace_switch_prompt_placeholder: '/Users/you/project',
    workspace_not_added: 'Forge was not added',
    workspace_already_saved: 'Forge already saved — choose it from the list',
    workspace_busy_switch: 'Cannot switch forge while agent is running',
    discard_file_edits_title: 'Discard file edits?',
    discard_file_edits_message: 'Switching forges will discard unsaved file edits in the preview.',
    workspace_switched_to: (name) => `Switched to ${name}`,
    profiles_no_profiles: 'No gods found.',
    ...
    profile_use: 'Use',
    profile_switch_title: 'Switch to this god',
    profile_delete_title: 'Delete this god',
    profile_default_label: '(default)',
    profile_name_placeholder: 'God name (lowercase, a-z 0-9 hyphens)',
    ...
    manage_profiles: 'Manage gods',
    profiles_load_failed: 'Failed to load profiles',
    profile_switched_new_conversation: (name) => `Switched to god: ${name} — new communion started`,
    profile_switched: (name) => `Switched to god: ${name}`,
    ...
    profile_created: (name) => `God created: ${name}`,
    profile_delete_confirm_title: (name) => `Delete god "${name}"?`,
    profile_delete_confirm_message: 'All communions, config, skills, and memory for this god will be permanently deleted. This cannot be undone.',
    profile_deleted: (name) => `God deleted: ${name}`,
    ...
    yolo_no_session: 'No active communion',
    yolo_enabled: '⚡ YOLO mode ON — approvals skipped this communion',
    ...
    composer_mobile_workspace: 'Forge',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'Pantheon のデフォルトと UI 動作。',
    ...
    onboarding_title: 'Pantheon へようこそ',
  ...
  ru: {
    ...
    session_toolsets: 'Communion Toolsets', // TODO: translate
    session_toolsets_desc: 'Restrict available tools for this communion (blank = use global config)', // TODO: translate
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    insights_sessions: 'Communions',  // TODO: translate
    ...
    subagent_children: 'Subagent communions',  // TODO: translate
  },
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'Pantheon 的預設值與介面行為。',
  ...
  ko: {
    ...
    settings_section_preferences_meta: 'Pantheon의 기본값과 UI 동작.',
    ...
    onboarding_title: 'Pantheon에 오신 것을 환영합니다',
