...
def test_list_requires_session_id():
    # Compatibility mode: GET /api/list without session_id now returns a
    # workspace picker payload (roots + items) for the hermes-ui merge.
    # The old 400 contract was intentionally widened.
